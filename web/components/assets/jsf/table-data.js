 var TableData = function() {
	...
	var runDataTable_example1 = function() {
		...
		var oTable = $('#sample_dashboard').dataTable({
			"dom": "Bfrtip",
			"buttons": [

					{
						...
						className: 'btn btn-default margin-right-10 btn-wide',
		...
		$('#sample_dashboard_wrapper .dataTables_filter input').addClass("form-control input-sm").attr("placeholder", "Search");
		// modify table search input
		$('#sample_dashboard_wrapper .dataTables_length select').addClass("m-wrap small");
		// modify table per page dropdown
		$('#sample_dashboard_wrapper .dataTables_length select').select2();
		// initialzie select2 dropdown
		$('#sample_dashboard_column_toggler input[type="checkbox"]').change(function() {
