...
function saveQuiz(scoreQuiz, timeSave, idSessionCurrent) {
    var path = Routing.generate('admin_candidat_score_quiz_elearning_session_by_formation', {idSession: idSessionCurrent});
    $.ajax({
        type: 'POST',
        url: path,
        dataType: 'json',
...
function statisticQuestion(statUserQuiz) {
    var path = Routing.generate('admin_candidat_statistic_questions_elearning_session_by_formation');
    $.ajax({
        type: 'POST',
        url: path,
        dataType: 'json',
