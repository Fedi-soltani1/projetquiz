    ...
    $.pdfviewer = function(element, options) {
        ...
        var defaults = {
            ...
            toolbar_template: '<div class="pdf-toolbar">' +
                ...
                '<div class="styleBtnNextPrev">\n' +
                '<button id="pdf-prev" class="btnNextPrevDoc btn btn-sm"><i class="fa fa-chevron-left"></i></button>\n' +
                ' <button id="pdf-next" class="btnNextPrevDoc btn btn-sm"> <i class="fa fa-chevron-right"></i></button>'+
                '</div>\n'+
                '</div>',
        ...
        plugin.init = function() {
            ...
            if ('undefined' != typeof PDFJS) {
                ...
                // pdfjsSrc = 'assets/total-task/js/pdf-viewer/pdfjs-dist/build/pdf.js';
        ...
        // private methods
        var build = function() {
            return   plugin.settings.viewer_template +plugin.settings.toolbar_template;
        }
